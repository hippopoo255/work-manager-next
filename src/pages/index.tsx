    ...
    <div className="p-page">
      ...
      <div className="p-card mx-4 mt-4">
        ...
        <div className="p-card__grid">
          ...
          />
          <div>Secondary</div>
          <Button text={t('header.signIn')} className={'--secondary-natural'} />
          ...
          <div>Disabled</div>
          <Button text={t('header.signIn')} className={'--disabled-natural'} />
          ...
          <div>Schedule</div>
          <Button text={t('header.signIn')} className={'--schedule-natural'} />
      ...
      <div className="p-card mx-4 mt-4">
        ...
        <div className="grid grid-cols-5 gap-x-2 gap-y-4">
          ...
          <BorderButton text={t('header.signIn')} className={'--danger-dark'} />
          <div>Minutes</div>
          <BorderButton
            text={t('header.signIn')}
          ...
          />
          <BorderButton text={t('header.signIn')} className={'--task-light'} />
          ...
          />
          <BorderButton text={t('header.signIn')} className={'--chat-light'} />
